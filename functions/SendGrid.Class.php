...
class wprm_SendgridMail {
	...
	public function loadPost($subject, $title, $url) {
		global $wprm_config;
		$content = 'Hello ' . $this->subscribe['name'] . ', <br><br> You asked for a PDF of a post, click the following link and the download should start within 20 seconds: <a href="' . $url . '">' . $title . '</a>.<br><br>If you did not request this email, someone else did it in your name. You can sinply ignore this. <br><br>' . $wprm_config['signature'];
